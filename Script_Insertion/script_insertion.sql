...
insert  into compte (_noentreprise__,is_admin,mail,pwd,_name,first_name,is_valid,creation_date,last_login,is_cgu,is_forgotpass,is_temp_password) values (1,true,'a@gmail.com','pwd','rob','rob',true,'1999-01-08','1999-01-08',true,false,false);
insert  into compte (_noentreprise__,is_admin,mail,pwd,_name,first_name,is_valid,creation_date,last_login,is_cgu,is_forgotpass,is_temp_password) values (2,true,'b@gmail.com','pwd2','bob','bob',true,'2000-01-08','2000-01-08',true,false,false);
...
insert  into question  (id_categorie,"type",libelle_question) values (4,'Question Choix Unique','Vos salariés ont-ils à disposition des masques anti-poussière');
insert  into question  (id_categorie,"type",libelle_question) values (2,'Question Choix Unique','Déplacez-vous les matériaux au plus près de la zone de chantier');
insert  into question  (id_categorie,"type",libelle_question) values (1,'Question Choix Multiple','Quels sont les EPI à disposition des salariés');
insert  into question  (id_categorie,"type",libelle_question) values (1,'Question Choix Multiple','Proposez-vous d''éventuelles formations à vos salariés parmi les choix suivants? ');

insert  into preconisation_globale  (id_questionnaire,contenu,viewIfPourcentageScoreLessThan) values (1,'En France, le risque électrique représente plus de 30% des incendies et plus de 10 morts par an',70);
insert  into preconisation_globale  (id_questionnaire,contenu,viewIfPourcentageScoreLessThan) values (1,'Selon l’art. R4544-9 et 10, l’habilitation électrique pour non électricien est obligatoire, en cas d’accident du travail la responsabilité civile ou pénale de l’employeur pourra être engagée. L’employeur s’expose aux versements de dommages et intérêts et à une amende',80);

insert  into preconisation_categorie  (id_categorie ,contenu,viewIfPourcentageScoreLessThan) values (2,'L’organisation du chantier est très importante, elle vous permettra d’éviter le port de charges inutiles et donc de réduire les risques physiques liées à la manutention manuelle qui représente 48% des accidents du travail',70);
insert  into preconisation_categorie  (id_categorie ,contenu,viewIfPourcentageScoreLessThan) values (4,'En 2019, l’amiante est à l’origine d’environ 3 000 maladies professionnelles et de 1 800 cancers. Si les moyens de protection nécessaires concernant ce risque ne sont pas respectés, vous risquez 1 an d’emprisonnement et 75 000 € d’amende pour mise en danger de la vie d’autrui',80);
