...
insert  into question  (id_categorie,q_type,libelle_question) values (4,'Question Choix Unique','Vos salariés ont-ils à disposition des masques anti-poussière');
insert  into question  (id_categorie,q_type,libelle_question) values (2,'Question Choix Unique','Déplacez-vous les matériaux au plus près de la zone de chantier');
insert  into question  (id_categorie,q_type,libelle_question) values (1,'Question Choix Multiple','Quels sont les EPI à disposition des salariés');
insert  into question  (id_categorie,q_type,libelle_question) values (1,'Question Choix Multiple','Proposez-vous d''éventuelles formations à vos salariés parmi les choix suivants? ');
